    ...
    <SafeAreaView style={styles.container}>
      <ScrollView style={styles.scrollView}>
        <View style={styles.header}>
          <Text style={styles.title}>Local Services Management</Text>
          <Text style={styles.description}>Manage local service providers and their offerings</Text>
        </View>
        ...
        <View style={styles.featuresContainer}>
          ...
          {[
            ...
            'Handle service bookings and appointments',
            'Monitor service quality and reviews',
            'Generate service performance reports',
            'Control pricing and commission rates',
