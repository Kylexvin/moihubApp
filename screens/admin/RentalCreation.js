...
const RentalCreation = ({ navigation }) => {
  const { token } = useAuth();
...
const handleSubmit = async () => {
  ...
  try {
    ...
    // ✅ Send hasVacant as boolean, not string
    formDataToSend.append('hasVacant', formData.hasVacant);
    ...
    const response = await axios.post(`${API_URL}/admin/rentals/create`, formDataToSend, {
      headers: {
    ...
    if (response.data.success) {
      Alert.alert(
        'Success',
        'Rental listing created and approved successfully!',
        [
          {
            text: 'OK',
        ...
        <View style={styles.form}>
          ...
          <View style={styles.inputGroup}>
            ...
            <View style={styles.switchContainer}>
              <View style={styles.switchRow}>
                <Text style={styles.switchLabel}>Has Vacant Rooms</Text>
                <Switch
                  trackColor={{ false: '#767577', true: '#059669' }}
                  thumbColor={formData.hasVacant ? '#ffffff' : '#f4f3f4'}
                  ios_backgroundColor="#3e3e3e"
                  onValueChange={(value) => handleInputChange('hasVacant', value)}
                  value={formData.hasVacant}
                />
              </View>
              <Text style={styles.switchDescription}>
                {formData.hasVacant 
                  ? 'This rental has vacant rooms available' 
                  : 'This rental is fully occupied'
                }
              </Text>
            </View>
          </View>
          ...
          >
            {loading ? (
              ...
              <Text style={styles.submitButtonText}>Create & Approve Listing</Text>
            )}
          </TouchableOpacity>
          ...
          <View style={styles.note}>
            ...
            <Text style={styles.noteText}>
              As admin, this listing will be automatically approved and go live immediately.
            </Text>
          </View>
        </View>
      </ScrollView>
